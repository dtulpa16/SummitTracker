...
import { SunIcon, MoonIcon, LoginIcon } from "@heroicons/react/solid";
...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto md:px-2 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="lg:ml-4 lg:flex lg:items-center">
              <button
                className="p-1 border-2 border-transparent text-white rounded-full hover:text-gray-500 focus:outline-none focus:text-gray-500 focus:bg-gray-100 transition duration-150 ease-in-out mr-3"
                aria-label="Login"
      ...
      <LoginModal theme={theme} isOpen={isOpen} setIsOpen={setIsOpen}/>
    </>
  );
};
